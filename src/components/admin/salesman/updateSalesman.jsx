...
const UpdateSalesman = () => {
    ...
    document.title = 'Update Salesman'
    CheckPageAccess();
    ...
    const handleOnChange = (e) => {
        ...
        console.log('-updateSalesman--typing-:', targetValue);
    ...
    const handleSubmit = (e) => {
        ...
        if(flag){
            Axios.post(`${process.env.REACT_APP_API_SERVICE}/salesman/update`, model)
            .then((result) => {
                console.log('-handleSubmit--update salesman--success--:', result);
    ...
    const getData = () => {
        Axios.get(`${process.env.REACT_APP_API_SERVICE}/salesman/getById/` + params.id)
        .then((result) => {
