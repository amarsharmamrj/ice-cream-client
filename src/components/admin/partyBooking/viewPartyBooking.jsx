...
const ViewPartyBooking = () => {
    const params = useParams();
    const history = useNavigate();
    document.title = 'View Party Booking'
    CheckPageAccess();
    ...
    return (
        ...
        <Typography variant="h2.heading" component="h2" className="page-heading">View Party Booking</Typography>
                            ...
                            {formData.products.length > 0 ? (
                                formData.products.map((row, i) => (
                                    <StyledTableRow key={row.product_name}>
                                      ...
                                      <StyledTableCell align="center">{row.discounted_rate}</StyledTableCell>
...
export default ViewPartyBooking;