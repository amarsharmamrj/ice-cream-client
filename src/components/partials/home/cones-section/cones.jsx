...
const Cones = () => {
  ...
  const getData = () => {
    Axios.get(`${process.env.REACT_APP_API_SERVICE}/product/getByCategory/Cone`)
    .then((result) => {
  ...
  useEffect(() => {
    ...
    return (
      ...
      <div className="section-even">
        <Typography variant="h2.heading" component="h2" className="section-heading">Cones</Typography>
        {dataLoaded ? (
          <Carousel 
