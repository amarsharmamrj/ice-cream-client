...
const Chocobars = () => {
  ...
  const getData = () => {
    Axios.get(`${process.env.REACT_APP_API_SERVICE}/product/getByCategory/Chocobar`)
    .then((result) => {
  ...
  useEffect(() => {
    ...
    return (
      ...
      <div className="section-odd">
        <Typography variant="h2.heading" component="h2" className="section-heading">Chocobars</Typography>
        {dataLoaded ? (
          <Carousel 
